<?php
	...
	$aColumnas = array('marca_nombre', 'marca_descripcion');
	
	/* columna indexada */
	$sIndexColumn = "marca_nombre";
...
/*	$rResult = $rResult->fetchAll(PDO::FETCH_ASSOC);*/
	...
	*/
	...
	foreach ( $data as $aRow ) {
		...
		$row[] = "<td><a href='#'' data-nombre=".$aRow['marca_nombre']." data-descripcion=".$aRow['marca_descripcion']." data-toggle='modal' data-target='#confirm-update'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#'' data-nombre=".$aRow['marca_nombre']." data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
		$output['aaData'][] = $row;
	}
