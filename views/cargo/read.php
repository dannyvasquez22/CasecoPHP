...
?>
	<div class="container">
		<div class="row">
			<h2 style="text-align:center">Cargos</h2>
		</div>
		...
		<div class="row table-responsive">
			<table class="display" id="tblCargo">
				<thead>
					<tr>
						<th>Nombre</th>
						<th>Descripción</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" method="POST" action="return false" onsubmit="return false" autocomplete="off">
					...
					<div class="form-group">
						<label for="sueldoMin" class="col-sm-3 control-label">Sueldo Mínimo</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="sueldoMin" name="sueldoMin" placeholder="Sueldo Mínimo" value="">
						</div>
					</div>
					
					<div class="form-group">
						<label for="sueldoMax" class="col-sm-3 control-label">Sueldo Máximo</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="sueldoMax" name="sueldoMax" placeholder="Sueldo Máximo" value="">
						</div>
					</div>
	...
	<script src="../../media/js/cargo.js"></script>
